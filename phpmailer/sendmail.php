...
$mail->Username   = 'denis.kasperovich@inbox.ru';                     //SMTP username
$mail->Password   = 'g7bsBsN7P99wG0waiMrA';                               //SMTP password
$mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
$mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

//Recipients
$mail->setFrom('denis.kasperovich@inbox.ru', 'Mailer');
$mail->addAddress('denis.kasperovich@inbox.ru', 'User');     //Add a recipient
